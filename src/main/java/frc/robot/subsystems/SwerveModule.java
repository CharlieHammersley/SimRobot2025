...
public class SwerveModule {
    ...
    public SwerveModule(int driveMotorId, int turningMotorId, boolean driveMotorReversed, boolean turningMotorReversed, int absoluteEncoderIs, double absoluteEncoderOffset, boolean absoluteEncoderReversed) {
    ...
    public void resetEncoders() { // sets drive encoder to 0 and the turning encoder to its absolute posiiton
